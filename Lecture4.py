...
print(arr2)
print("Element at index 1, row 1, column 2:")
print(arr2[0, 0, 1])
print("Element at index 1, row 4, column 2:")
print(arr2[1, 1, 1])
print("Element at index 2, row 1, column 3:")
print(arr2[0, 0, 2])
print("Element at index 2, row 4, column :3")
print(arr2[1, 1, 2])
print("Adding element at index 2, row 1, column 3  and index 2, row 4, column 3:")
